...
def print_an_integer_many_times_on_one_row():
    ...
    # -------------------------------------------------------------------------
    number = int(input('Show me the number!'))
    sequence = ''
    for k in range(number):
        sequence = sequence + str(number*2)
    print(sequence)
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # -------------------------------------------------------------------------
    decimal = float(input('What decimal number?'))
    integer = int(input('What integer?'))
    word = input('what string?')
